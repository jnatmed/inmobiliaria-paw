...
/* parts/button-logout.html */
class __TwigTemplate_86e3373428bc651f8fce9ae4618d16e5 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        yield "<div class=\"fundo__geral fundo__geral--claro\">
        <button class=\"elemento__botao_saida elemento__botao_saida--escuro\">
            <svg class=\"elemento__botao--porta\" viewBox=\"0 0 100 100\">
                <path
                ...
                <path class=\"elemento__botao--detalhe-batida\"
                    d=\"M40.5 43.7L26.6 31.4l-2.5 6.7zM41.9 50.4l-19.5-4-1.4 6.3zM40 57.4l-17.7 3.9 3.9 5.7z\" />
            </svg>
            <svg class=\"elemento__botao--conjunto\" viewBox=\"0 0 100 100\">
                ...
                <g class=\"elemento__botao--braco1\">
                    <path
                ...
                <g class=\"elemento__botao--braco2\">
                    <path
                ...
                <g class=\"elemento__botao--perna1\">
                    <path
                ...
                <g class=\"elemento__botao--perna2\">
                    <path
            ...
            <span class=\"elemento__botao--texto\">SALIR</span>
        </button>
    </div>";
        return; yield '';
    }
    ...
    {
        return "parts/button-logout.html";
    }
    ...
    {
        return new Source("<div class=\"fundo__geral fundo__geral--claro\">
        <button class=\"elemento__botao_saida elemento__botao_saida--escuro\">
            <svg class=\"elemento__botao--porta\" viewBox=\"0 0 100 100\">
                <path
                    d=\"M93.4 86.3H58.6c-1.9 0-3.4-1.5-3.4-3.4V17.1c0-1.9 1.5-3.4 3.4-3.4h34.8c1.9 0 3.4 1.5 3.4 3.4v65.8c0 1.9-1.5 3.4-3.4 3.4z\" />
    ...
    </div>", "parts/button-logout.html", "D:\\BackUps\\Documentos\\UNLu\\Programacion Web\\inmobiliaria-paw\\src\\App\\views\\parts\\button-logout.html");
    }
}
