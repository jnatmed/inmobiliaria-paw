...
class Publicacion extends Model
{
    ...
    {
        return $this->nombre_alojamiento;
    }
    public function setNombreAlojamiento($nombre_alojamiento)
    {
        $this->nombre_alojamiento = $nombre_alojamiento;
    }

    public function getTipoAlojamientoId()
    {
        return $this->tipo_alojamiento_id;
    }
    public function setTipoAlojamientoId($tipo_alojamiento_id)
    {
        $this->tipo_alojamiento_id = $tipo_alojamiento_id;
    }
    ...
    public function getCantBanios()
    {
        return $this->cant_banios;
    }
    public function setCantBanios($cant_banios)
    {
        $this->cant_banios = $cant_banios;
    }

    public function getCantidadDormitorios()
    {
        return $this->cantidad_dormitorios;
    }
    public function setCantidadDormitorios($cantidad_dormitorios)
    {
    ...
    public function getPileta()
    {
        return $this->pileta;
    }
    public function setPileta($pileta)
    {
        $this->pileta = $pileta;
    }
    ...
    public function setAireAcondicionado($aire_acondicionado)
    {
    ...
    public function getNormasAlojamiento()
    {
        return $this->normas_alojamiento;
    }
    public function setNormasAlojamiento($normas_alojamiento)
    {
        $this->normas_alojamiento = $normas_alojamiento;
    }

    public function getDescripcionAlojamiento()
    {
        return $this->descripcion_alojamiento;
    }
    public function setDescripcionAlojamiento($descripcion_alojamiento)
    {
        $this->descripcion_alojamiento = $descripcion_alojamiento;
    }
